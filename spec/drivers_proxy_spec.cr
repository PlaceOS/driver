...
describe ACAEngine::Driver::Proxy::Drivers do
  it "should execute functions on collections of remote drivers" do
    ...
    result.is_a?(ACAEngine::Driver::Proxy::Drivers::Responses).should eq(true)
    ...
    message = messages[0]
    req_out = ACAEngine::Driver::Protocol::Request.from_json(String.new(message[4, message.bytesize - 4]))
