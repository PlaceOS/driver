...
class PlaceOS::Driver::Subscriptions
  ...
  def initialize(logger_io = STDOUT, module_id = "")
    ...
    @subscriptions = {} of String => Array(PlaceOS::Driver::Subscriptions::Subscription)

    # System ID to subscriptions
    @redirections = {} of String => Array(PlaceOS::Driver::Subscriptions::IndirectSubscription)
  ...
  def channel(name, &callback : (PlaceOS::Driver::Subscriptions::ChannelSubscription, String) -> Nil) : PlaceOS::Driver::Subscriptions::ChannelSubscription
    ...
    if channel = sub.subscribe_to
      ...
      if subscriptions = @subscriptions[channel]?
        ...
        subscriptions = @subscriptions[channel] = [] of PlaceOS::Driver::Subscriptions::Subscription
        subscriptions << sub
